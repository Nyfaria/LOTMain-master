    ...
    public static void register(CommandBuildContext buildContext, CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(
                Commands.literal("beyonder")
                        ...
                        .then(Commands.argument("class", BeyonderClassArgument.beyonderClass())
                                .then(Commands.argument("class_level", IntegerArgumentType.integer(0, 9))
                                        .executes(context -> {
                                            BeyonderClass result = BeyonderClassArgument.getBeyonderClass(context, "class");
                                            int level = IntegerArgumentType.getInteger(context, "class_level");
                                            if (result == null) {

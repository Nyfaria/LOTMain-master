...
public class AdvancementEffect9 extends MobEffect {
    ...
    public void applyEffectTick(LivingEntity pEntity, int pAmplifier) {
        ...
        var effect1 = new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,120,4);
        effect1.setCurativeItems(List.of());
        var effect2 = new MobEffectInstance(MobEffects.CONFUSION,120,1);
        effect2.setCurativeItems(List.of());
        var effect3 = new MobEffectInstance(MobEffects.POISON,120,20);
        effect2.setCurativeItems(List.of());
